...
class ClusterEmbeddings:
    ...
    def __get_model(self, k: int):
        ...
        elif self.algorithm == 'algocust':
            return AgglomerativeClustering(k)
    ...
    def __get_centroids(self, model):
        ...
        if self.algorithm =="agglocust":
            clf = NearestCentroid()
            y_predict = self.__get_model(self.n_culsters).fit_predict(self.features)
            clf.fit(self.features, y_predict)
